...
- **H10b-G is the lead packet result.** The completed 70B grid shows M1 is variant-selective: it held baseline and v3 payloads at 0/10 strict bypass, while v7 bypassed M1 at 10/10 under the same Groq-hosted Llama-3.3-70B single-provider boundary. See [ATTACKS/2026-05-18-h10b-g-70b-substrate-grid-m1-variant-selective.md](../ATTACKS/2026-05-18-h10b-g-70b-substrate-grid-m1-variant-selective.md).
- **Pre-registered H7 falsified at 70B.** The implicit "70B is safer, the effect washes out at scale" assumption was registered as H7 before the cell ran, then falsified: under the same inline-XML substrate, Llama-3.3-70B reached 10/10 strict canary exfil where 8B reached 0/5. Capability amplifies exploitation within the insecure substrate. See [ATTACKS/2026-05-16-cline-70b-M0-f1-substrate-replication.md](../ATTACKS/2026-05-16-cline-70b-M0-f1-substrate-replication.md) and Addendum B of [WRITEUPS/2026-05-14-mcp-substrate-vs-policy.md](../WRITEUPS/2026-05-14-mcp-substrate-vs-policy.md).
...
|---|---|---|---|
| H10b-G shows M1 is variant-selective at 70B, not a substrate fix. | [ATTACKS/2026-05-18-h10b-g-70b-substrate-grid-m1-variant-selective.md](../ATTACKS/2026-05-18-h10b-g-70b-substrate-grid-m1-variant-selective.md) | Single Groq-hosted Llama-3.3-70B provider/model family, inline-XML substrate, lab-only canaries, n=10 cells. | The pristine frozen OpenRouter H10b run, a production exploit, or proof that prompt scaffolding is sufficient. |
...
| Pre-registered H7 (70B reproduces the 8B rate) was falsified: capability amplifies exploitation within the insecure substrate. | [ATTACKS/2026-05-16-cline-70b-M0-f1-substrate-replication.md](../ATTACKS/2026-05-16-cline-70b-M0-f1-substrate-replication.md) | n=10, single payload, single client, open-weight on a free tier; mechanism-level mode shift, not a population rate. | A frontier-vendor rate, a production exploit, or a population rate across payloads or vendors. |
...
- **Single model (now extended to 70B).** The original matrix was Llama 3.1 8B Instruct only. *[Resolved 2026-05-17: the cross-scale cell F1 measured Llama-3.3-70B under the same substrate; see the H7 row above and Addendum B. The "larger models not measured" gap is closed for the M0 baseline; cross-model breadth under `xml-parser` remains a follow-on.]*
...
- **No measurement of larger models under XML-parser substrate.** *[Resolved 2026-05-17: measured. F1 (n=10) shows the amplifier does not become negligible at 70B; it strengthens (0/5 strict at 8B to 10/10 at 70B). The implicit claim of takeaway 2 is falsified, not confirmed. See Addendum B.]*
...
The portfolio is intentionally open-weight at this stage; see [open-weights-rationale.md](open-weights-rationale.md). The cross-scale question is no longer open in the speculative sense: the pre-registered F1 cell already shows the substrate effect strengthening from 8B to 70B (open-weight), so an open-weight result is a conservative lower bound rather than a weaker proxy. H10b-G adds the completed mitigation-boundary grid: M1 can hold some payload families while failing cleanly on v7, so prompt scaffolding remains defense in depth rather than the durable substrate fix. A frontier substrate replication on Claude (pre-registered as H10, with falsifier criteria for both replication and collapse) remains the next-phase confirmation.
